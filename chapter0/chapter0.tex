...
Grâce à leurs structures en cha\^ine cin\'ematique ferm\'ee, les 
...
\input{./chapter0/figures/gough.pdf_tex}
...
conditionnement ou de ``pick and place'']{\label{intro:fig3view2}  
\includegraphics[width=.50\linewidth]{./chapter0/figures/parallelrobot03.jpg}}
...
\begin{figure}[!ht]
  \centering
      \subfloat[Robot s\'erie]{\label{intro:fig3bview0}
\includegraphics[width=.40\linewidth]{./chapter0/figures/ws_serie.jpg}} 
\hfill
    \subfloat[Robot parall\`ele]{\label{intro:fig3bview1} 
\includegraphics[width=.58\linewidth]{./chapter0/figures/ws_parallel.jpg}}
...
Dans ce but, plusieurs types de systèmes peuvent être utilisés, parmi lesquels 
nous pouvons citer :
\begin{itemize}
...
linéairement sur des rails, permettant un contrôle de la longueur] 
{\label{intro:fig4view1}   
...
\begin{figure}[!ht]
  \centering
  \subfloat[Nist Robocrane]{\label{intro:fig5bview0}
\includegraphics[width=.50\linewidth]{./chapter0/figures/nist.jpg}}
\subfloat[SEGESTA]{\label{intro:fig5bview1}
\includegraphics[width=.40\linewidth]{./chapter0/figures/segesta.png}} \\
\subfloat[Le robot d\'evelopp\'e dans le cadre du 
projet CoGiRo]{\label{intro:fig5bview2}
\includegraphics[width=.90\linewidth]{./chapter0/figures/cablebot.png}}
\caption{\footnotesize Exemples de robots parall\`eles \`a c\^ables}
\label{intro:fig5b}
\end{figure}

\noindent {\bf NIST Robocrane} :\\

D\'ev\'elopp\'e au d\'ebut des ann\'ees 90, {\tt Robocrane} 
...
Les {\tt Marionet} sont une famille de robots à câbles développés par l'EPI 
...
travail peut aller jusqu\`a $75m\times45m\times30m$, et la l\'eg\`eret\'e de son 
\'equipement garantit 
...
un seul point]{\label{intro:fig9view1}
  \includegraphics[width=.3\linewidth]{./chapter0/figures/cfg_41.png}}  \hfill
...
même point, le quatrième est relié en un point distinct]{\label{intro:fig9view2}
  \includegraphics[width=.3\linewidth]{./chapter0/figures/cfg_431.png}}
...
utilisé la configuration $4-1$ (Fig.\ref{intro:fig9view1}) qui nous permet de 
...
déplacer dans la quasi-totalité de l'appartement-témoin. 

Les câbles de ce robot sont en Kevlar, ce qui nous permet de négliger leur 
...
\includegraphics[width=.43\linewidth]{./chapter0/figures/view_appartment01.jpg}}
 \hfill
  \subfloat[Vue aérienne de l'appartement-témoin]{\label{intro:fig10view1} 
\includegraphics[width=.52\linewidth]{./chapter0/figures/view_appartment04.jpg}}
\\
  \subfloat[Plateforme de {\tt Marionet-Assist}]{\label{intro:fig10view2}
  \includegraphics[width=.41\linewidth]{./chapter0/figures/view_plateform.jpg}} 
\hfill
  \subfloat[Système d'enroulement et actionneurs pour un 
câble]{\label{intro:fig10view3}
  \includegraphics[width=.55\linewidth]{./chapter0/figures/view_winches02.jpg}}
...
\begin{figure}[!ht]
  \centering
      \subfloat[Forme d'un câble (pointill\'es bleus) dont la tension serait 
nulle]{\label{intro:fig6view0}
\def\svgwidth{.45\linewidth}
\input{./chapter0/figures/nulltensionwire.pdf_tex}} 
\hfill
\subfloat[Lorsqu'une tension positive est exerc\'ee sur un c\^able 
non-\'elastique, sa longueur d\'eroul\'ee réelle correspond à la distance entre 
ses points d'attache.]{\label{intro:fig6view1}
\def\svgwidth{.45\linewidth}
...
En différentiant (\ref{intro:eq8}), on obtient :
\begin{equation}
...
\begin{figure}[!ht]
  \centering
    \def\svgwidth{.95\linewidth}
      \input{./chapter0/figures/spheres.pdf_tex}
