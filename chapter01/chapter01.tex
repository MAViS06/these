...
Il est ainsi possible de red\'efinir toutes les fonctions \`a valeurs 
...
En utilisant l'analyse par intervalle, nous assurons une robustesse aux erreurs 
...
I$]{\label{chap01:fig06view0}
 \includegraphics[width=.45\linewidth]{./chapter01/figures/interval_in.png}}
 \subfloat[Cas 02 : $\exists (x,y) \in \hbox{[}X\hbox{]}^2, f(x) 
\in I, f(y) \notin I$]{\label{chap01:fig06view1}
 \includegraphics[width=.45\linewidth]{./chapter01/figures/interval_inout.png}} 
\\
  \subfloat[Cas 03 : $\forall x \in \hbox{[}X\hbox{]}, f(x) \notin I$] 
{\label{chap01:fig06view2}
 \includegraphics[width=.45\linewidth]{./chapter01/figures/interval_out.png}}
    \caption{\footnotesize{Trois situations de test d'hypoth\`ese en analyse 
par intervalles : inclusion totale, inclusion partielle, exclusion totale.}}
\label{chap01:fig06}
\end{figure}
...
\begin{figure}[!htp]
  \centering
 \subfloat[En bas \`a gauche : les deux c\^ables mous se succ\`edent, la zone 
verte correspond alors \`a la r\'egion qui n'est plus atteignable ; en haut \`a 
droite : l'un des c\^ables mous n'a pas de voisin imm\'ediat qui soit lui aussi 
mous, la zone en bleu correspond \`a la r\'egion qui n'est plus atteignable. 
]{\label{chap01:fig10view0}
 \def\svgwidth{.45\linewidth}
 \input{./chapter01/figures/drawing_robot86.pdf_tex}} \hfill
 \subfloat[L'octogone au centre de la figure 
correspond \`a la r\'egion de l'espace de travail 
pouvant \^etre atteinte par l'ensemble des 28 
configurations de 6 c\^ables.]{\label{chap01:fig10view1}
 \def\svgwidth{.45\linewidth}
 \input{./chapter01/figures/drawing_robot86bis.pdf_tex}} 
    \caption{\footnotesize{Robot \`a 8 c\^ables in\'elastiques dont les points 
d'attache sont dispos\'es en octogone. En haut, sont montr\'ees les r\'egions 
inatteignables de l'espace de travail lorsque les c\^ables 0 et 7 sont mous 
(r\'egion verte en bas \`a gauche), ou lorsque le c\^able 3 est mou 
(r\'egion bleue en haut \`a droite). La figure du bas montre ainsi la r\'egion 
de l'espace de travail qui peut \^etre atteinte par l'ensemble des 
configurations de 6 c\^ables en tension, soit $28$ sous-robots $A^{6,6}$}}
