...
Soit $m$ l nombre de câbles et $n$ le nombre de degrés de liberté du robot. Le {\MGSI} est un problème à $2m$ inconnues ($m$ longueurs + $m$ tensions) et à $n+m$ équations (le modèle géométrique indirect en fourni $m$ et l'équilibre statique $n$). 
