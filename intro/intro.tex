...
Les architectures parallèles en particulier présentent une des déclinaisons 
...
pneumatiques]{\label{intro:fig3view0}
    \includegraphics[width=.34\linewidth]{./intro/figures/parallelrobot01.jpg}} 
\hfill
...
\\
    \subfloat[Robot Delta, particulièrement adapté aux tâches de conditionnement 
...
système de poulie actionnée par un moteur]{\label{intro:fig4view0}
    \includegraphics[width=.55\linewidth]{./intro/figures/winchesactuator.jpg}} 
\hfill
...
\includegraphics[width=.50\linewidth]{./intro/figures/robot_cdpr_noncrane.jpg}} 
\hfill
...
nulle]{\label{intro:fig6view0}
    \includegraphics[width=.35\linewidth]{./intro/figures/nulltensionwire.png}} 
\hfill
    \subfloat[Câble élastique sur lequel est appliquée une tension positive : la 
...
En posant ${\bf \tau} = (\tau_1, \tau_2, \dots, \tau_n)^T$, ${\bf W}$ la matrice 
...
Si l'on veut résoudre le {\it MGD} pour un robot à câbles, l'ensemble suivant 
...
\begin{figure}[!ht]
  \centering
    ...
    \includegraphics[width=.45\linewidth]{./intro/figures/marionet01.jpg}} 
\hfill
...
Le robot {\tt Marionet-Assist} a été développé dans un objectif d'assistance aux 
...
Dans cette configuration, nous ne contrôlons que les trois degrés de liberté 
...
contexte de ces travaux.
 ...
 \subsection{Modèles de capteurs et projections} \label{chap0-3-0}
