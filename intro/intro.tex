...
\begin{figure}[!ht]
  \centering
    \subfloat[gg]{\label{intro:fig7view0}
    \includegraphics[width=.90\linewidth]{./intro/figures/marionet03.jpg}} \\
    \subfloat[gg]{\label{intro:fig7view1}
    \includegraphics[width=.49\linewidth]{./intro/figures/marionet01.jpg}} \hfill
    \subfloat[gg]{\label{intro:fig7view2}
    \includegraphics[width=.49\linewidth]{./intro/figures/marionet02.jpg}}
    \caption{\footnotesize{gg}}
\label{intro:fig7}
\end{figure}
...
\begin{figure}[htp]
  \centering
  \subfloat[Light walking aid]{\label{intro:fig8view0}
  \includegraphics[width=.2\linewidth]{./intro/figures/case01.jpg}} \hfill
  \subfloat[Case of an hemiplegic user]{\label{intro:fig8view1}
  \includegraphics[width=.2\linewidth]{./intro/figures/case02.jpg}} \hfill
  \subfloat[Case of a paraplegic user]{\label{intro:fig8view2}
